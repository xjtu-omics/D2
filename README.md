...
# Typical workflow
D3 takes 3dg file and an index file as input, and output bed-like file storing the DNA density and DisTP. Besides, we provided here the scripts for computing the enrichments of genetic markers.
